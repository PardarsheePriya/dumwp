...
import sty from "./PlasmicChallengesBar.module.css"; // plasmic-import: vssiSWnI8sS0/css
...
function PlasmicChallengesBar__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__uhqrC)}>
        <PlasmicImg__
        ...
        <div className={classNames(projectcss.all, sty.freeBox__fHuuz)} />
      </div>
      <div
        className={classNames(
          projectcss.all,
