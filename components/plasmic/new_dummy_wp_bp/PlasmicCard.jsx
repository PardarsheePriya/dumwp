...
import sty from "./PlasmicCard.module.css"; // plasmic-import: DVyswejEmoUn/css
import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: HKHd4WtpiKJA/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: JAqk2d9jM2EV/icon
import BulletDashSvgIcon from "./icons/PlasmicIcon__BulletDashSvg"; // plasmic-import: X15sSMbj3c3_/icon
...
function PlasmicCard__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__pyO0H, {
            [sty.freeBoxnoTitle__pyO0HBTsp]: hasVariant(
              $state,
              "noTitle",
              "noTitle"
            )
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__sjqA8)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
          ...
          {false ? (
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <CheckSvgIcon
                    className={classNames(projectcss.all, sty.svg__mcZhl)}
                    role={"img"}
                  />
                ),
          ...
          {false ? (
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <IconIcon
                    className={classNames(projectcss.all, sty.svg__jvgNd)}
                    role={"img"}
                  />
                ),
